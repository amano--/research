...
](https://frontend-digest.com/using-playwright-to-test-next-js-applications-80a767540091)
E2Eテストフレームワークで MSW の intercept、イマイチ痒いところに手が届かない感じがしてたんだけど、この手があったかー。記事は Playwright だけど、ちょっと工夫すれば Cypress でも同じこと出来そう
